...
OUTCOME_TO_CONSTRAINTS = {
    (Outcome.ALL, Outcome.NONE)  : (Con.BANISH, Con.SPECIALISATION),
...
class Constrain:
    ...
    def make_clause_inclusion_rule(self, clause, clause_handle):
        ...
        yield ('INCLUSION',(Literal('included_clause', (clause_handle, clause_number)), tuple(literals)))
    ...
    def banish_constraint(self, program):
        ...
        yield (Con.BANISH, (None, tuple(literals)))
    ...
    def generalisation_constraint(self, program):
        ...
        yield (Con.GENERALISATION, (None, tuple(literals)))
    ...
    def specialisation_constraint(self, program):
        ...
        yield (Con.SPECIALISATION, (None, tuple(literals)))
    ...
    def redundant_literal_constraint(self, clause):
        ...
        yield (None, (None, tuple(literals)))
    ...
    def redundancy_constraint(self, program):
        ...
        for lit in lits_num_clauses.keys() - recursively_called:
            ...
            yield (Con.REDUNDANCY, (None, tuple(literals)))
